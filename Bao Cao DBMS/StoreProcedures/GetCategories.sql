-- Trả ra danh sách category (Tìm kiếm, phân trang, sắp xếp)
...
-- EXEC
EXEC[dbo].[GetCategories] @SearchValue = null, @SortOrderName="name", @SortOrder="desc", @CurrentPage=1, @PageSize=5
EXEC[dbo].[GetCategories] @SearchValue = "abc", @SortOrderName="Name", @SortOrder="desc", @CurrentPage=1, @PageSize=5